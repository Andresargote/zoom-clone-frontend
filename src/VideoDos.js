...
const server_url = "https://zoom-clone-server-andres.herokuapp.com/";
...
class VideoDos extends Component {
  constructor(props) {
    super(props);
      ...
      <div>
        {this.state.askForUsername ? (
          <div className={styles.setName}>
            <div>
              <input
                placeholder="Por favor introduce tu nombre aquí"
                value={this.state.username}
                onChange={(e) => this.handleUsername(e)}
              />
              <button onClick={this.connect}>Entrar a la reunión</button>
            </div>
          </div>
        ) : (
          <>
            <div className={styles.container}>
              <div className={styles.videoContainer} id="main">
            ...
            <div className={styles.containerButtons}>
              {this.state.video ? (
                <div className={styles.icon} onClick={this.handleVideo}>
                  <Video />
                </div>
              ) : (
                <div className={styles.icon} onClick={this.handleVideo}>
              ...
              {this.state.audio ? (
                <div className={styles.icon} onClick={this.handleAudio}>
                  <Mic />
                </div>
              ) : (
                <div className={styles.icon} onClick={this.handleAudio}>
              ...
              <div className={styles.iconRed} onClick={this.handleEndCall}>
                <PhoneOff />
              </div>
            </div>
          </>
